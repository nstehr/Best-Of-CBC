...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\bestofcbc on
     Windows, /home/user/dev/bestofcbc on Linux) in a file named
     bestofcbc@nathan.stehr and copy that file to
